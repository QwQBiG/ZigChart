...
Pull requests should explain the concrete problem, resulting behavior, relevant validation, and material limitations. Avoid duplicate diff reports in the repository. Performance claims require reproducible measurements with their environment and workload; otherwise describe the intended optimization without claiming a measured improvement.
